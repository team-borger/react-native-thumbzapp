...
const XenditInvoiceLoad = ({ navigation }: Props) => {
  ...
  const getLink = async () => {
    const link = await AsyncStorage.getItem('xenditInvoiceLoadUrl');
    setLink(link);
  };
...
export default memo(XenditInvoiceLoad);
