...
const CheckoutFood = ({ navigation }: Props) => {
  ...
  const _onPlaceOrder = () => {
    ...
    checkoutAPI({ food_orders: true, ids: cart_id, user_address_id: selectedAddress.id }, openWebViewer, getError)
  }
  ...
  return (
    <SafeAreaView edges={['bottom', 'left', 'right']} style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        ...
        />
        <TouchableHighlight onPress={() => navigation.navigate('MyAddressCheckout', { isFood: true })}  underlayColor="white" style={{borderColor: '#880ED4',  borderWidth: 1, margin: 10, padding: 10, borderRadius: 10}}>
