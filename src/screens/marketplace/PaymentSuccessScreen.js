    ...
    <SafeAreaView edges={['bottom', 'left', 'right']} style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={{flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', marginHorizontal: 20}}>
          <Text style={ payMethod.method_type === 'Cash on Delivery' ? {display: 'none'} : {color: '#880ED4', fontSize: 24, fontWeight: 'bold'}}><FontAwesome name='check-circle' size={24} color='#880ED4' /> You paid {'\u20B1'} {formatNumber(subTotal)}</Text>
          ...
          <View style={{marginTop: 40}}>
            <Button style={{marginTop: 15, borderColor: '#880ED4'}} mode="outlined" textColor="#880ED4" onPress={_goBack}>
              Back to Home
            </Button>
            <Button style={{marginTop: 15, borderColor: '#880ED4'}} mode="outlined" textColor="#880ED4" onPress={_goToOrders}>
              Go to Orders
            </Button>
          </View>
        </View>
