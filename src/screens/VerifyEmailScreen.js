      ...
      <View style={styles.contentContainer}>
        <View style={styles.skeks}>
          <View style={{alignItems: 'center'}}>
            <Text style={{fontSize: 24, fontWeight: 'bold', color: 'gray'}}>Verify Your Email</Text>
            <Text style={{fontSize: 16, color: 'gray', textAlign: 'center', paddingTop: 10}}>Check your email and click the button to activate your account.</Text>
          </View>
